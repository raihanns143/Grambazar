    ...
    <main className="bg-gray-50/50 min-h-screen">
      ...
      <div className="pt-32 pb-20 max-w-md mx-auto px-4">
        <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
          ...
          <p className="text-gray-500 text-center mb-8">Join GramBazar today</p>
          
          <form onSubmit={handleRegister} className="space-y-5">
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">Full Name</label>
              <input required type="text" value={name} onChange={e=>setName(e.target.value)} className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary" placeholder="John Doe" />
            </div>
            <div>
